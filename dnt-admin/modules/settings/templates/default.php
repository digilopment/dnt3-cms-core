   ...
   <div class="row">
      <div class="col-md-12">
         <ul class="nav nav-tabs">
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 1 or !isset($_GET[ 'pa'])) {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=1">Nastavenia stránky</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'default') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=default">Základné nastavenia</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'logo') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=logo">Nastavenie loga</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'default_images') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=default_images">Nastavenie defaultných obrázkov</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'social') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=social">Nastavenia social. siet</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'social_wall') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=social_wall">Social Wall</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'keys') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=keys">Nastavenia kľúčov</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'extends') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=extends">Rozšírené nastavenia</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 7 && $_GET[ 'category'] == 'vendor') {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=7&category=vendor">Nastavenia firmy</a></li>
            <li <?php if (isset($_GET[ 'pa']) && $_GET[ 'pa'] == 6) {
                echo 'class="active"';
                }?>><a href="index.php?src=settings&pa=6">Nastavenia účtu (krátke)</a></li>
         </ul>
                  ...
                  <div class="col-md-12">
                     ...
                     <div class=" tab-content">
                        ...
                        <div class="tab-pane active" id="sutaz">
                           ...
                           <input type="submit" name="Pa7" class="btn btn-primary btn-lg btn-block" value="Upraviť">
                        </div>
                     </div>
                  </div>
               </form>
