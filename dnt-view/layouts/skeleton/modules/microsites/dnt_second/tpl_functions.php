...
function getModul($modul, $image, $CAPTCHA, $CAPTCHA_MIN, $CAPTCHA_MAX, $NO_ROBOT, $link_region_dest, $link_region_show, $link_partner_dest, $link_partner_show) {
    ...
    elseif ($modul == Dnt::name_url(Meta::getCompetitionMeta('_menu_name_4'))) {
        ...
        <?php } ?>
                    ...
                    $.ajax({
                    type: "POST",
                            url: "./dnt-system/api/json/ajax.php?type=<?php echo Meta::creat_key(Vendor::getId()); ?>&no_robot=<?php echo $NO_ROBOT; ?>",
                            data: $(form).serialize(),
                            timeout: "10000",
                            dataType: "json",
        ...
        <section class="registration">
            ...
            <?php if (Meta::getCompetitionMetaExists('form_extend_v1_doklad')) { ?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="ans" name="ans" placeholder="<?php echo not_html(Meta::getCompetitionMeta('form_extend_v1_doklad')); ?>">
                                            </div>
                                        </div>
            <?php } elseif (Meta::getCompetitionMetaExists('form_extend_v2_otazka')) { ?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="" name="ans" placeholder="<?php echo not_html(Meta::getCompetitionMeta('form_extend_v2_otazka')); ?>">
                                            </div>
                                        </div>
