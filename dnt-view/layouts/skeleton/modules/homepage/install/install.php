...
function defaultModulMetaDataInstalation($postId, $moduleName){
	...
	return array(
		"sql" => "
			(null, 0, $postId, '$moduleName', ".Vendor::getId().", 'info_hotel_name_1', '".$defaultContent."', 'content', 	2, 'Názov hotelu 1', 				1),
			(null, 0, $postId, '$moduleName', ".Vendor::getId().", 'info_hotel_addr_1', '".$defaultContent."', 'content', 	2, 'Url adresa hotelu 1', 			1),
			(null, 0, $postId, '$moduleName', ".Vendor::getId().", 'info_hotel_tel_c_1','".$defaultContent."', 'content', 	2, 'Telefón do hotela 1', 			1),
			(null, 0, $postId, '$moduleName', ".Vendor::getId().", 'info_hotel_email_1','".$defaultContent."', 'content', 	2, 'Email hotelu 1', 				1),
			...
			(null, 0, $postId, '$moduleName', ".Vendor::getId().", 'link_hotel_1', 		'".$defaultContent."', 'content', 	2, 'Url adresa hotela 1', 			1);
		"
	);
