                  ...
                  <?php
                     ...
                     ?>
					  <div class="blog-grid masonry-box-in col-3">
						 <h3><a href="<?php echo  $article->getPostParam("name_url", $row['id']); ?>"><?php echo $article->getPostParam("name", $row['id']); ?></a></h3>
						 <hr>
						 <p><?php echo $article->getPostParam("perex", $row['id']); ?></p>
						 <a class="r-more" href="<?php echo $article->getPostParam("name_url", $row['id']); ?>"><?php echo $translate['citat_viac'];?></a>
					  </div>
					<?php
                     }
                    }
