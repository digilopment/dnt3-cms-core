    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('Ĺ Ĺ˝ĹˇĹľĹ¸Ă€ĂĂ‚ĂĂ„Ă…Ă‡ĂĂ‰ĂŠĂ‹ĂŚĂŤĂŽĂŹĂ‘Ă’Ă“Ă”Ă•Ă–ĂĂ™ĂšĂ›ĂśĂťĂ ĂˇĂ˘ĂŁĂ¤ĂĄĂ§Ă¨Ă©ĂŞĂ«Ă¬Ă­Ă®ĂŻĂ±Ă˛ĂłĂ´ĂµĂ¶Ă¸ĂąĂşĂ»ĂĽĂ˝Ăż'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('Ăž' => 'TH', 'Ăľ' => 'th', 'Ă' => 'DH', 'Ă°' => 'dh', 'Ăź' => 'ss', 'Ĺ’' => 'OE', 'Ĺ“' => 'oe', 'Ă†' => 'AE', 'Ă¦' => 'ae', 'Âµ' => 'u'));
