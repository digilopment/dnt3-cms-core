...
class NewsletterCampaignTest
{
    ...
    protected function getSeenLogs()
    {
        ...
        /* $query = "SELECT * FROM `dnt_logs` WHERE 
          ...
          //GROUP BY timestamp"; */
        $query = "SELECT msg, system_status, timestamp FROM `dnt_logs` WHERE `system_status` = 'newsletter_log_seen' AND `msg` LIKE '%" . $this->campaignId . "%' AND vendor_id = '" . $this->vendor->getId() . "'";
    ...
    protected function getClickLogs()
    {
        ...
        /* $query = "SELECT * FROM `dnt_logs` WHERE 
          ...
          //GROUP BY timestamp"; */
        $query = "SELECT msg, system_status, timestamp FROM `dnt_logs` WHERE `system_status` = 'newsletter_log_click' AND `msg` LIKE '%" . $this->campaignId . "%' AND vendor_id = '" . $this->vendor->getId() . "'";
    ...
    protected function getLogs()
    {
        ...
        /* $query = "SELECT * FROM `dnt_logs` WHERE 
          ...
          AND `msg` LIKE '%" . $this->campaignId . "%'
          AND vendor_id = '" . $this->vendor->getId() . "'"; */
        $query = "SELECT msg, system_status, timestamp FROM `dnt_logs` WHERE (`system_status` = 'newsletter_log_seen' OR `system_status` = 'newsletter_log_click') AND `msg` LIKE '%" . $this->campaignId . "%' AND vendor_id = '" . $this->vendor->getId() . "'";
    ...
    {
        $query = "SELECT id, name, surname, email, datetime_creat, `show` FROM `dnt_mailer_mails` WHERE  `vendor_id` = '" . $this->vendor->getId() . "'  AND  cat_id = '" . $this->emailCatId . "' ORDER BY `show` DESC, `name` ASC";
